...
const LoginWithApple = dynamic(() => import("../components/shared/Auth/LoginWithApple"), {
    ssr: false,
  });
  ...
  return {
    props: {
      ...
      meta:{
        ...
        pageUrl:"https://www.joinclipper.com/welcome",
          ...
          <div className="col-lg-4 px-5 bg-white" style={{ height: "100vh" }}>
            ...
            <div className="welcome-wrapper">
              ...
              <p style={{ fontSize: "12px" }}>
                Congrats! Clipper is installed. Unlock more features and get
