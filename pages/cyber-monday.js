...
export async function getStaticProps() {
  ...
  return {
    props: {
      meta:{
        title:"Cyber Monday Deals & Sale - Save Big on Best Deals from Top Stores",
        description:"Best Cyber Monday Deals & Sale to shop this year and save up to 80% on electonics, books, toys, fashion, gift cards & more!",
        keywords:"Cyber Monday Deals, Cyber Monday Sale, Walmart Cyber Monday, Best Buy Cyber Monday, Best Cyber Monday Deals, Target Cyber Monday, Macys Cyber Monday 2022, Kohls Cyber Monday, Cyber Monday Deals 2022, Cyber Monday 2022 Deals, Newegg Cyber Monday, Cyber Monday TV Deals, Cyber Monday Sale 2022",
        pageUrl:"https://www.joinclipper.com/cyber-monday",
      ...
      <div className="container">
        ...
        <div className="py-2">
          ...
          <div className="mt-5 mb-3 d-flex justify-content-between align-items-center">
            ...
            <span className="fw-bold para">view all</span>
          </div>

          {/* body */}
          <div className="row coupon-card my-2">
            <div className="col-lg-3">
              <div className="card blackFridayitem" style={{ width: "16rem" }}>
                <img
                  className="card-img-top"
