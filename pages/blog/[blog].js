    ...
    return {
      props: {
        ...
        meta:{
          ...
          pageUrl:"https://www.joinclipper.com/blog/"+slug,
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="item7-card-desc d-flex mb-2 mt-3">
                  ...
                  {data?.blog.createdAt.slice(0,10)}
                </div>
                <div
                      ...
                      <ul className="list-group mb-0">
                        <li className="list-group-item">
                          <div className="row my-4">
                            <div className="col-lg-4"><a href="#" className="text-dark">
                              <div className="card">
                                <img src="https://cdn.honey.io/images/store-logos/326944219204203689.png" width="100%" alt="" />
                              </div>
                            </a></div>
                            <div className="col-lg-4"><a href="#" className="text-dark">
                              <div className="card">
                          ...
                          <div className="row my-4">
                            <div className="col-lg-4"><a href="#" className="text-dark">
                              <div className="card">
                                <img src="https://cdn.honey.io/images/store-logos/294748574666744778.png" width="100%" alt="" />
                              </div>
                            </a></div>
                            <div className="col-lg-4"><a href="#" className="text-dark">
                              <div className="card">
