    ...
    return {
        props: {
            ...
            meta:{
                ...
                pageUrl:"https://www.joinclipper.com/how-it-works",
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    <div className="col-lg-4 my-auto px-5">
                        <img src="https://super-dashboard-images-cdn.s3.amazonaws.com/images/1648028812332-clipper-logo.png" alt="cliper-logo" style={{ position: "absolute", top: "3%" }} />
                    ...
                    <div className="col-lg-8 bg-white howitwork-video" >
                        <video controls loop={true} autoPlay width="700px">
                            <source src="https://super-dashboard-images-cdn.s3.amazonaws.com/videos/1648123121132-how-it-works.mp4" type="video/ogg" />
