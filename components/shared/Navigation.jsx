...
export default function Navigation() {
  ...
  return (
    <div className="container-fluid navWrapper">
        ...
        <nav className="navbar navbar-expand-lg navbar-light ">
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <div className="logo">
              <Link href="/" passHref>
                <img
                  src="https://super-dashboard-images-cdn.s3.amazonaws.com/images/1647511627608-header-logo.png"
            ...
            >
              ...
              <input
                className="form-control shadow-none header-input"
                type="search"
            ...
            {user ? (
              <div className="clipper-menu-icon">
                <img
                  className="me-1"
                  src="images/clipper-menu-icon.png"
                  alt=""
                />{" "}
                0 Coins
              </div>
      ...
      {/* mobile navbar */}
      <div className="container-fluid Mobile-menu-item">
        <div
          className="row"
        ...
        >
          <div className="d-flex align-items-center">
            <div>
              <Link href="/" passHref>
                <img
                  src="https://super-dashboard-images-cdn.s3.amazonaws.com/images/1646029569208-favicon.png"
                  style={{
                    cursor: "pointer",
                    marginRight: "15px",
                    height: "38px",
