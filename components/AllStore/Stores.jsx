        ...
        <div className="allstoreHeader">
          <div className="sub-head d-flex justify-content-center align-items-center my-4">
            <h1>
              ...
              <span className="fw-light">CLIPPER</span>
            </h1>
          </div>
        ...
        endMessage={
          <p style={{ textAlign: "center" }}>
            <div className="container text-start">
              <h3>ALL STORES</h3>
              <p>
                Think of a store and shop there from here. Clipper hunts for the
              ...
              <p>
                Every time you shop with us, you earn clipper coins worth real
              ...
              <p>
                Note: The range of clipper coins differs with every store shown
                below and applies to specific items. Terms and Exceptions apply.
              </p>

              <p>
                Exceptions - The number of clipper coins will vary for each
                ...
                for earning clipper coins. However, these exceptions and
                exclusions vary and are decided by the stores. Please remember,
                Clipper can’t decide whether the products you have purchased are
                eligible for earning clipper coins or not until after you have
                made the purchase. Therefore, if you have bought ineligible
                items for clipper coins, you will not earn any clipper coins
                through your purchases. Hence, the final number of coins earned
                will be rewarded directly to your clipper wallet, and you will
