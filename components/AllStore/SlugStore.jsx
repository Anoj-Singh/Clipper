...
export default function SlugStore({ coupons, store,slug }) {
  return (
    <>
      <div className="container-fluid my-4">
        <div className="container">
          <div className="row">
            <div className="col-lg-3 border py-3 h-100" style={{width: "23%", marginRight: "2%", background:"white"}}>
              <img
                src={
              ...
              <p className="my-3 text-center" style={{ fontSize: "10px" }}>
                When you buy through links on Clipper we may earn a commission.{" "}
              </p>
              <hr></hr>
              {store && store.metadata.special_conditions && (
                <>
                  <h5 className="text-center">
                    Special Condition (lightinthebox.com)
                  </h5>
                  <p style={{ fontSize: "14px" }}>
                    {store.metadata.special_conditions}
                  </p>
                </>
              )}
              ...
              <table style={{ width: "100%", marginBottom:"15px" }}>
                <tbody>
                  ...
                  <tr>
                    <td style={{fontSize:"14px"}}>Clipper Rewards</td>
                    <td style={{ textAlign: "right", fontWeight: "600", fontSize:"14px" }}>
                      5%
                    </td>
                  </tr>
              ...
              {/* <button className="btn popularDealsBtn" style={{width:"77%"}}>Activate Gold</button> */}
              <span id="visit-official-site"><svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" className="injected-svg" data-src="https://cdn.honey.io/images/icon-2_0/external_link-16.svg" xmlnsXlink="http://www.w3.org/1999/xlink"><path d="M6.894 3.84a.75.75 0 1 0 0-1.5v1.5zm6.765 6.15a.75.75 0 0 0-1.5 0h1.5zm-1.75 3.26H3v1.5h8.91v-1.5zM2.75 13V4.09h-1.5V13h1.5zM3 3.84h3.894v-1.5H3v1.5zm9.16 6.15V13h1.5V9.99h-1.5zM3 13.25a.25.25 0 0 1-.25-.25h-1.5c0 .966.784 1.75 1.75 1.75v-1.5zm8.91 1.5A1.75 1.75 0 0 0 13.66 13h-1.5a.25.25 0 0 1-.25.25v1.5zM2.75 4.09A.25.25 0 0 1 3 3.84v-1.5a1.75 1.75 0 0 0-1.75 1.75h1.5z" fill="#212121" className="fill" /><path d="M10.15 2H14v4.171" stroke="#212121" strokeWidth="1.2" strokeLinecap="round" className="stroke" /><path d="M6.796 8.08a.75.75 0 0 0 1.06 1.06l-1.06-1.06zm6.417-6.418L6.796 8.08l1.06 1.061 6.418-6.417-1.061-1.06z" fill="#212121" className="fill" /></svg></span>
            </div>
              ...
              <div className="mid-ad text-center">
                ...
                <div className="storeheadertext d-flex justify-content-between align-items-center px-3">
                  ...
                  <button className="view-site fw-normal bg-white">
                    <a
                      href={`https://${store ? store.domain:slug}`}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <div className="mb-3" id="sectionBody" key={coupon._id}>
                      <div className="coupon-item rounded p-3 bg-white border d-flex justify-content-between align-items-center">
                        <div className="d-flex imgtext">
                          ...
                          <div className="ms-4">
                            <p className="para mb-0">{coupon.type === "coupon"
                              ? "Coupon"
                              : "Deal"}</p>
                            <p
                            ...
                            <span
                              ...
                              style={{ fontWeight: "400", marginTop: "0.5rem", fontWeight:"12px !important" }}
                            >
